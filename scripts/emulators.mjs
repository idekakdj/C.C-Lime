...
const javaFolder = readdirSync('.tools/java').find(name => name.includes('jre'));
if (!javaFolder) throw new Error('Install Java 21 and set JAVA_HOME, or add the verified portable JRE under .tools/java.');
const javaHome = path.resolve('.tools/java', javaFolder);
